...
#
![image](./image/1-instance-of-Cloudant.jpg)
![image](./image/2-active.jpg)
![image](./image/3-Databases.jpg)
![image](./image/4-create-the-database.jpg)
![image](./image/5-database.jpg)
![image](./image/6-Service-credentials.jpg)
![image](./image/7-credentials.jpg)
![image](./image/8-credentials.jpg)
![image](./image/9-%20create-a-namespace.jpg)
![image](./image/10-%20create-a-namespace.jpg)
![image](./image/11-Node-js-action.jpg)
![image](./image/12-Node-js-action.jpg)
![image](./image/13-Sequence.jpg)
![image](./image/14-Sequence.jpg)
![image](./image/15-Add-a-second-action-to-this-sequence.jpg)
![image](./image/16-Add-a-second-action-to-this-sequence.jpg)
![image](./image/17-Invoke-with-parameters.jpg)
![image](./image/18-Invoke-with-parameters.jpg)
![image](./image/19-created-document.jpg)
![image](./image/20-set-read-input.jpg)
![image](./image/21-second-action.jpg)
![image](./image/22-read-guestbook-entries-sequence.jpg)
![image](./image/23-web-action.jpg)
![image](./image/24-web-action.jpg)
![image](./image/25-API.jpg)
![image](./image/26-operation.jpg)
![image](./image/27-operation-put.jpg)
![image](./image/28-API.jpg)
![image](./image/29-Developer.jpg)
